...
void print_versn(unsigned char *e_ident);
void print_abi(unsigned char *e_ident);
void print_os_abi(unsigned char *e_ident);
void print_tp(unsigned int e_type, unsigned char *e_ident);
...
/**
 * print_versn - Prints the version of an ELF header.
...
/**
 * print_tp - Prints the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_tp(unsigned int e_type, unsigned char *e_ident)
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	print_versn(header->e_ident);
	print_os_abi(header->e_ident);
	print_abi(header->e_ident);
	print_tp(header->e_type, header->e_ident);
