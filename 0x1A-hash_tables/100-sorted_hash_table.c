...
/**
 * shash_table_set - set a key to a value present in the hash table
...
/**
 * shash_table_get - restore a value from the hash table
 * @ht: hash table
 * @key: key to the data
 *
...
/**
 * shash_table_print_rev - reversed printing of hash_table
...
{
	shash_node_t *tmp;
	char flag = 0; /* 0 before printing any data,  or 1 after*/
